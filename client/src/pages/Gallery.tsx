...
import { ArrowLeft, Database, ExternalLink, Filter, RefreshCw, Search, ShieldCheck, SlidersHorizontal } from "lucide-react";
...
export default function Gallery() {
  ...
  return <div className="site-shell gallery-page">
    ...
    <header className="nav-wrap"><Link className="brand" href="/punks-base-collection/"><span className="brand-mark"><img src={`${ASSET_ROOT}cryptopunk-2890.png`} alt="" /><i /></span><span>PUNKS<span>/</span>BASE</span></Link><nav className="gallery-nav"><a href={BASESCAN} target="_blank" rel="noreferrer">Contract <ExternalLink size={13} /></a><a href={OPENSEA} target="_blank" rel="noreferrer">OpenSea <ExternalLink size={13} /></a></nav></header>
    <main>
